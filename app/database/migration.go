...
func ViewMigrate(){
	...
	if DropViewIfExist("v_get_user") != false{
		if ChecktableExist("v_get_user") == true {
			db.Exec("CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_get_user`  AS  "+ v_get_user() +";")
		}
	}
	...
	if DropViewIfExist("v_get_grup") != false{
		if ChecktableExist("v_get_grup") == true {
			db.Exec("CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_get_grup`  AS  "+ v_get_grup() +";")
		}
	}
	...
	if DropViewIfExist("v_get_user_grup") != false{
		if ChecktableExist("v_get_user_grup") == true {
			db.Exec("CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_get_user_grup`  AS  "+ v_get_user_grup() +";")
		}
	}
	...
	if DropViewIfExist("v_get_privilege") != false{
		if ChecktableExist("v_get_privilege") == true {
			db.Exec("CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_get_privilege`  AS  "+ v_get_privilege() +";")
		}
	}
	...
	if DropViewIfExist("v_get_grup_privilege") != false{
		if ChecktableExist("v_get_grup_privilege") == true {
			db.Exec("CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_get_grup_privilege`  AS  "+ v_get_grup_privilege() +";")
		}
	}
